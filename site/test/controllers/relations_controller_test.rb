...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { create: @relation.create, delete: @relation.delete, index: @relation.index, new: @relation.new, show: @relation.show, update: @relation.update } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { create: @relation.create, delete: @relation.delete, index: @relation.index, new: @relation.new, show: @relation.show, update: @relation.update } }
